...
let anotherLatte = new Latte("small", false, "whole milk");
anotherLatte.description();
...
class Americano extends Coffee {
    strength;
    constructor(size, isDecaf, strength) {
        super(size, isDecaf);
        this.strength = strength;
    }
    description() {
        console.log(`A ${this.size} Americano with ${this.strength} strength.`);
    }
}

let myAmericano = new Americano("large", false, "medium");
myAmericano.description();
myAmericano.serveIt();
